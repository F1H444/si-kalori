                    ...
                    >
                        ...
                        <div className="bg-white border-4 border-black p-6 mb-8 relative overflow-hidden">
                            ...
                            <div className="text-center p-4 bg-gray-100 border-2 border-black mb-4">
                                <span className="block text-sm font-bold text-gray-500 line-through">Rp 99.000</span>
                                <span className="text-3xl font-black">Rp 49.000</span>
                                <span className="text-sm font-bold">/bulan</span>
                            </div>

                            <button
                                onClick={() => window.open("https://wa.me/6281234567890?text=Halo%20Admin,%20saya%20mau%20upgrade%20Premium%20SiKalori!", "_blank")}
